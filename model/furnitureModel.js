...
var furnitureDB = {
    ...
    getPromotionFurniture: function () {
        return new Promise((resolve, reject) => {
            var conn = db.getConnection();
            conn.connect(function (err) {
                if (err) {
                    ...
                    var sql = 'SELECT i.ID as id, i.NAME as name, f.IMAGEURL as imageURL, i.SKU as sku, i.DESCRIPTION as description,'
                        + ' i.TYPE as type, i._LENGTH as length, i.WIDTH as width, i.HEIGHT as height, i.CATEGORY as category'
                        + ' FROM itementity i, furnitureentity f , promotionentity p where i.ID=f.ID and i.ID=p.ITEM_ID and i.ISDELETED=FALSE ';
                    conn.query(sql, function (err, result) {
                        if (err) {
                            conn.end();
                            return reject(err);
            ...
            conn.connect(function (err) {
                if (err) {
                    ...
                    var sql = 'SELECT i.ID as id, i.NAME as name, f.IMAGEURL as imageURL, i.SKU as sku, i.DESCRIPTION as description,'
                        + ' i.TYPE as type, i._LENGTH as length, i.WIDTH as width, i.HEIGHT as height, i.CATEGORY as category '
                        + ' FROM itementity i, furnitureentity f, promotionentity p WHERE i.ID=f.ID AND i.ID=p.ITEM_ID AND i.ISDELETED=FALSE '
                        + ' AND NOW() <= p.ENDDATE AND DATE(p.ENDDATE) = DATE(NOW() + INTERVAL 1 DAY)';
                    conn.query(sql, function (err, result) {
                        if (err) {
                            conn.end();
                            return reject(err);
    ...
    //combine one
    getPromotionFurnitureByFilter: function (sortOrder, cat) {
        return new Promise((resolve, reject) => {
            ...
            conn.connect(function (err) {
                if (err) {
                    ...
                    let sql = 'SELECT i.ID as id, i.NAME as name, f.IMAGEURL as imageURL, i.SKU as sku, i.DESCRIPTION as description,' +
                        ' i.TYPE as type, i._LENGTH as length, i.WIDTH as width, i.HEIGHT as height, i.CATEGORY as category' +
                        ' FROM itementity i, furnitureentity f, promotionentity p' +
                        ' WHERE i.ID=f.ID and i.ID=p.ITEM_ID and i.ISDELETED=FALSE';
                    ...
                    const queryParams = cat !== undefined ? [cat] : [];
    ...
    getPromotionFurnitureByCat: function (cat) {
        return new Promise((resolve, reject) => {
            var conn = db.getConnection();
            ...
            conn.connect(function (err) {
                if (err) {
                    ...
                    var sql = 'SELECT i.ID as id, i.NAME as name, f.IMAGEURL as imageURL, i.SKU as sku, i.DESCRIPTION as description,'
                        + ' i.TYPE as type, i._LENGTH as length, i.WIDTH as width, i.HEIGHT as height, i.CATEGORY as category'
                        + ' FROM itementity i, furnitureentity f , promotionentity p where i.ID=f.ID and i.ID=p.ITEM_ID and i.ISDELETED=FALSE and i.CATEGORY=?';
    ...
    getPromotionFurnitureByName: function (order) {
        return new Promise((resolve, reject) => {
            var conn = db.getConnection();
    ...
    getLastChanceFurnitureByCat: function (cat) {
        return new Promise((resolve, reject) => {
            var conn = db.getConnection();
    ...
    getLastChanceFurnitureByName: function (order) {
        return new Promise((resolve, reject) => {
            var conn = db.getConnection();
